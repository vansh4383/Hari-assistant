...
if is_admin():
    ...
    print(current_time)
    time.sleep(2)
    website_list = ["www.facebook.com","facebook.com","wwww.youtube.com","youtube.com"] #Enter the websites that you want to block 
    ...
    while True:     
        ...
        current_time = datetime.datetime.now().strftime("%H:%M")
        website_list = ["www.facebook.com","facebook.com","wwww.youtube.com","youtube.com"]  
